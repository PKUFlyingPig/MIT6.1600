...
class Server(ABC):
    ...
    @abstractmethod
    def update_public_profile(self, request: types.UpdatePublicProfileRequest) -> types.UpdatePublicProfileResponse:
        pass

    @abstractmethod
    def get_friend_public_profile(self, request: types.GetFriendPublicProfileRequest) -> types.GetFriendPublicProfileResponse:
        pass
    ...
    @abstractmethod
    def synchronize(self, request: types.SynchronizeRequest) -> types.SynchronizeResponse:
        pass
